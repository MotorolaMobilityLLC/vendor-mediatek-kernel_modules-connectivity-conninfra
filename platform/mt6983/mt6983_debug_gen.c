...
void __iomem *vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 = NULL;
...
void consys_debug_init_mt6983_debug_gen(void)
{
	...
	vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 = ioremap(CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_BCRM_BASE_ADDR, 0x414);
}
...
void consys_debug_deinit_mt6983_debug_gen(void)
{
	...
	if (vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983);
}
		...
		struct conn_debug_info_mt6983 *pdbg_level_2_info)
{
	...
	if (!vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 +
	...
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			"42", 0x1804f000 + 0x400,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 + 0x400));

	/* 43 */
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			"43", 0x1804f000 + 0x404,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 + 0x404));

	/* 44 */
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			"44", 0x1804f000 + 0x408,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 + 0x408));

	/* 45 */
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			"45", 0x1804f000 + 0x40c,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 + 0x40c));

	/* 46 */
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			"46", 0x1804f000 + 0x410,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 + 0x410));

	/* 47 */
	update_debug_read_info_mt6983_debug_gen(pdbg_level_2_info,
			"47", 0x1804f000 + 0x414,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6983 + 0x414));
}
