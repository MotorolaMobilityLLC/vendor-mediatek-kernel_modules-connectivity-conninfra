 ...
 *
 * This file, mt6879_debug_gen.c was automatically generated
...
void __iomem *vir_addr_consys_dbg_gen_srclkenrc_base_mt6879 = NULL;
void __iomem *vir_addr_consys_dbg_gen_topckgen_base_mt6879 = NULL;
void __iomem *vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 = NULL;
void __iomem *vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879 = NULL;
void __iomem *vir_addr_0x1804c000_mt6879 = NULL;
void __iomem *vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 = NULL;

void consys_debug_init_mt6879_debug_gen(void)
{
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6879 = ioremap(CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR, 0x77C);
	vir_addr_consys_dbg_gen_topckgen_base_mt6879 = ioremap(CONSYS_DBG_GEN_TOPCKGEN_BASE_ADDR, 0x180);
	vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 = ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_BASE_OFFSET_ADDR, 0xBA4);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879 = ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x41c);
	vir_addr_0x1804c000_mt6879 = ioremap(0x1804c000, 0xc);
	vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 = ioremap(CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_BCRM_BASE_ADDR, 0x414);
}

void consys_debug_deinit_mt6879_debug_gen(void)
{
	if (vir_addr_consys_dbg_gen_srclkenrc_base_mt6879)
		iounmap(vir_addr_consys_dbg_gen_srclkenrc_base_mt6879);

	if (vir_addr_consys_dbg_gen_topckgen_base_mt6879)
		iounmap(vir_addr_consys_dbg_gen_topckgen_base_mt6879);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879);

	if (vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879)
		iounmap(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879);

	if (vir_addr_0x1804c000_mt6879)
		iounmap(vir_addr_0x1804c000_mt6879);

	if (vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879);
}
		...
		struct conn_debug_info_mt6879 *pdbg_level_0_info)
{
	...
	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt6879));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_srclkenrc_base_mt6879) {
		pr_notice("vir_addr_consys_dbg_gen_srclkenrc_base_mt6879(%x) ioremap fail\n",
				CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_topckgen_base_mt6879) {
		pr_notice("vir_addr_consys_dbg_gen_topckgen_base_mt6879(%x) ioremap fail\n",
	...
	/* A0 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_0_info,
	...
	update_debug_read_info_mt6879_debug_gen(pdbg_level_0_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6879 +
	...
	/* A7 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_0_info,
			"A7", 0x10000000 + CONSYS_DBG_GEN_CLK_CFG_17_OFFSET_ADDR,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_topckgen_base_mt6879 +
				CONSYS_DBG_GEN_CLK_CFG_17_OFFSET_ADDR));
		...
		struct conn_debug_info_mt6879 *pdbg_level_1_info)
{
	...
	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt6879));
	...
	update_debug_write_info_mt6879_debug_gen(pdbg_level_1_info,
			"B0", 0x18060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x0);

	update_debug_read_info_mt6879_debug_gen(pdbg_level_1_info,
		...
		struct conn_debug_info_mt6879 *pdbg_level_2_info)
{
	...
	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt6879));

	if (level < 2)
		return;

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879(%x) ioremap fail\n",
	...
	/* C0 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
	...
	update_debug_write_info_mt6879_debug_gen(pdbg_level_2_info,
	...
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xB8C));

	/* C17 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"C17", 0x18050000 + 0xB90,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xB90));

	/* C18 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"C18", 0x18050000 + 0xB94,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xB94));

	/* C19 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"C19", 0x18050000 + 0xB98,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xB98));

	/* C20 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"C20", 0x18050000 + 0xB9C,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xB9C));

	/* C21 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"C21", 0x18050000 + 0xBA0,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xBA0));

	/* C22 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"C22", 0x18050000 + 0xBA4,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6879 + 0xBA4));
}
		...
		struct conn_debug_info_mt6879 *pdbg_level_1_info)
{
	...
	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879(%x) ioremap fail\n",
				CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR);
		return;
	}

	/* write 0x18023408[31:0] = 0x0 */
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879 +
	...
	update_debug_read_info_mt6879_debug_gen(pdbg_level_1_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6879 +
		...
		struct conn_debug_info_mt6879 *pdbg_level_2_info)
{
	...
	if (!vir_addr_0x1804c000_mt6879) {
		pr_notice("vir_addr_0x1804c000_mt6879(%x) ioremap fail\n",
				0x1804c000);
		return;
	}

	if (!vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"37", 0x1804c000 + 0x4,
			CONSYS_REG_READ(vir_addr_0x1804c000_mt6879 + 0x4));

	/* 38 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"38", 0x1804c000 + 0xc,
			CONSYS_REG_READ(vir_addr_0x1804c000_mt6879 + 0xc));

	/* 39 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"39", 0x1804f000 + CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_BCRM_1804f000_OFFSET_ADDR,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 +
	...
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"42", 0x1804f000 + 0x400,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 + 0x400));

	/* 43 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"43", 0x1804f000 + 0x404,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 + 0x404));

	/* 44 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"44", 0x1804f000 + 0x408,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 + 0x408));

	/* 45 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"45", 0x1804f000 + 0x40c,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 + 0x40c));

	/* 46 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"46", 0x1804f000 + 0x410,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 + 0x410));

	/* 47 */
	update_debug_read_info_mt6879_debug_gen(pdbg_level_2_info,
			"47", 0x1804f000 + 0x414,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_off_bus_bcrm_base_mt6879 + 0x414));
}
