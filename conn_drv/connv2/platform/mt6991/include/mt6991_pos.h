...
#ifndef _PLATFORM_MT6991_POS_H_
#define _PLATFORM_MT6991_POS_H_

#include <linux/types.h>

unsigned int consys_emi_set_remapping_reg_mt6991(phys_addr_t con_emi_base_addr,
	phys_addr_t md_shared_emi_base_addr, phys_addr_t gps_emi_base_addr);
unsigned int consys_emi_set_remapping_reg_mt6991_atf(phys_addr_t con_emi_base_addr,
	phys_addr_t md_shared_emi_base_addr, phys_addr_t gps_emi_base_addr);
