 ...
 *
 * This file, mt6858_debug_gen.c was automatically generated
 * by the tool from the DEBUG data DE provided.
 * It should not be modified by hand.
 *
 * Reference debug file,
 * - [Axxxxxs] connsys_power_debug_20240409.xlsx (Modified date: 2025-04-11)
 * - [Axxxxxs] conn_infra_bus_debug_ctrl_20240409.xlsx (Modified date: 2023-08-18)
 */
...
#include "include/mt6858_debug_gen.h"
...
mapped_addr vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858;
mapped_addr vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858;

void consys_debug_init_mt6858_debug_gen(void)
{
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6858
	...
	vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858
		= ioremap(CONSYS_DBG_GEN_INST2_CONN_WT_SLP_CTL_REG_BASE_ADDR, 0x12C);
	vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858
		= ioremap(CONSYS_DBG_GEN_CONN_RF_SPI_MST_REG_BASE_ADDR, 0x320);
	vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_BASE_OFFSET_ADDR, 0xE9C);
	vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858
		= ioremap(CONSYS_DBG_GEN_INST2_CONN_RF_SPI_MST_REG_BASE_ADDR, 0x108);
	vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_AXI_LAYER_BUS_BCRM_BASE_ADDR, 0xc);
}

void consys_debug_deinit_mt6858_debug_gen(void)
{
	if (vir_addr_consys_dbg_gen_srclkenrc_base_mt6858)
		iounmap(vir_addr_consys_dbg_gen_srclkenrc_base_mt6858);
	...
	if (vir_addr_consys_dbg_gen_conn_wt_slp_ctl_reg_base_mt6858)
		iounmap(vir_addr_consys_dbg_gen_conn_wt_slp_ctl_reg_base_mt6858);

	if (vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858)
		iounmap(vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858);

	if (vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858)
		iounmap(vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858);

	if (vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858)
		iounmap(vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858);

	if (vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858);
}

void update_debug_read_info_mt6858_debug_gen(
		struct conn_debug_info_mt6858 *info,
		char *tag,
...
void update_debug_write_info_mt6858_debug_gen(
		struct conn_debug_info_mt6858 *info,
		char *tag,
...
void consys_print_power_debug_dbg_level_0_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;

	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt6858));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_srclkenrc_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_srclkenrc_base_mt6858(%x) ioremap fail\n",
				CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_cksys_reg_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_cksys_reg_base_mt6858(%x) ioremap fail\n",
...
void consys_print_power_debug_dbg_level_1_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;

	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt6858));
	...
	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6858(%x) ioremap fail\n",
	...
	update_debug_write_info_mt6858_debug_gen(pdbg_level_1_info,
		"B0", 0x18060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
		0, 2, 0x0);

	update_debug_read_info_mt6858_debug_gen(pdbg_level_1_info,
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_1_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6858 +
...
void consys_print_power_debug_dbg_level_2_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;

	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt6858));
	...
	if (!vir_addr_consys_dbg_gen_conn_wt_slp_ctl_reg_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_conn_wt_slp_ctl_reg_base_mt6858(%x) ioremap fail\n",
				CONSYS_DBG_GEN_CONN_WT_SLP_CTL_REG_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858(%x) ioremap fail\n",
				CONSYS_DBG_GEN_INST2_CONN_WT_SLP_CTL_REG_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858(%x) ioremap fail\n",
				CONSYS_DBG_GEN_CONN_RF_SPI_MST_REG_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858(%x) ioremap fail\n",
				CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_BASE_OFFSET_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858(%x) ioremap fail\n",
	...
	/* C0 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_wt_slp_ctl_reg_base_mt6858 +
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858 +
			CONSYS_DBG_GEN_WB_CK_STA_OFFSET_ADDR));
	...
	/* C18 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C18", 0x18003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_4_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_inst2_conn_wt_slp_ctl_reg_base_mt6858 +
			CONSYS_DBG_GEN_WB_SLP_TOP_CK_4_OFFSET_ADDR));
	...
	update_debug_write_info_mt6858_debug_gen(pdbg_level_2_info,
		"C19", 0x18011000 + CONSYS_DBG_GEN_EMI_CTL_0_OFFSET_ADDR,
		21, 22, 0x0);
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_rf_spi_mst_reg_base_mt6858 +
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE74));

	/* C36 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C36", 0x18050000 + 0xE78,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE78));

	/* C37 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C37", 0x18050000 + 0xE7C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE7C));

	/* C38 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C38", 0x18050000 + 0xE80,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE80));

	/* C39 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C39", 0x18050000 + 0xE84,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE84));

	/* C40 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C40", 0x18050000 + 0xE88,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE88));

	/* C41 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C41", 0x18050000 + 0xE8C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE8C));

	/* C42 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C42", 0x18050000 + 0xE90,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE90));

	/* C43 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C43", 0x18050000 + 0xE94,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE94));

	/* C44 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C44", 0x18050000 + 0xE98,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE98));

	/* C45 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C45", 0x18050000 + 0xE9C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xE9C));

	/* C46 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C46", 0x18050000 + 0xBCC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBCC));

	/* C47 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C47", 0x18050000 + 0xBD0,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBD0));

	/* C48 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C48", 0x18050000 + 0xBD4,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBD4));

	/* C49 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C49", 0x18050000 + 0xBD8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBD8));

	/* C50 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C50", 0x18050000 + 0xBDC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBDC));

	/* C51 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C51", 0x18050000 + 0xBE0,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBE0));

	/* C52 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C52", 0x18050000 + 0xBE4,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBE4));

	/* C53 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C53", 0x18050000 + 0xBE8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBE8));

	/* C54 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C54", 0x18050000 + 0xBEC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBEC));

	/* C55 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C55", 0x18050000 + 0xBF0,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBF0));

	/* C56 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C56", 0x18050000 + 0xBF4,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBF4));

	/* C57 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C57", 0x18050000 + 0xBF8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBF8));

	/* C58 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C58", 0x18050000 + 0xBFC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xBFC));

	/* C59 */
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		"C59", 0x18050000 + 0xC00,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6858 + 0xC00));
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_inst2_conn_rf_spi_mst_reg_base_mt6858 +
			CONSYS_DBG_GEN_SPI_STA_OFFSET_ADDR));
...
void consys_print_bus_debug_dbg_level_1_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
	...
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6858 +
...
void consys_print_bus_debug_dbg_level_2_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	if (!vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6858_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6858 +
...
void consys_print_bus_slpprot_debug_dbg_level_2_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
...
void consys_print_bus_slpprot_debug_dbg_level_0_mt6858_debug_gen(
		int level,
		struct conn_debug_info_mt6858 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
