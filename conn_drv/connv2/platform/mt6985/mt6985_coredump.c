...
struct consys_platform_coredump_ops g_consys_platform_coredump_ops_mt6985 = {
	...
	.consys_coredump_setup_dynamic_remap = consys_plt_coredump_setup_dynamic_remap_mt6985,
