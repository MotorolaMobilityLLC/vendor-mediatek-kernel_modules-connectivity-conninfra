...
int consys_spi_read_mt6886_atf(enum sys_spi_subsystem subsystem, unsigned int addr,
	unsigned int *data)
{
	struct arm_smccc_res res;
	int ret;
...
int consys_spi_write_mt6886_atf(enum sys_spi_subsystem subsystem, unsigned int addr,
				unsigned int data)
{
	int ret = 0;
...
int consys_spi_update_bits_mt6886_atf(enum sys_spi_subsystem subsystem, unsigned int addr,
