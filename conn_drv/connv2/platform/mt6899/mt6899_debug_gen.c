 ...
 *
 * This file, mt6899_debug_gen.c was automatically generated
 * by the tool from the DEBUG data DE provided.
 * It should not be modified by hand.
 *
 * Reference debug file,
 * - [Pxxxxs]connsys_power_debug.xlsx (Modified date: 2024-04-18)
 * - [Pxxxxs]conn_infra_bus_debug_ctrl.xlsx (Modified date: 2024-05-02)
 */
...
#include "include/mt6899_debug_gen.h"


mapped_addr vir_addr_consys_dbg_gen_srclkenrc_base_mt6899;
mapped_addr vir_addr_consys_dbg_gen_topckgen_base_mt6899;
mapped_addr vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899;

void consys_debug_init_mt6899_debug_gen(void)
{
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6899
		= ioremap(CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR, 0x77C);
	vir_addr_consys_dbg_gen_topckgen_base_mt6899
		= ioremap(CONSYS_DBG_GEN_TOPCKGEN_BASE_ADDR, 0xF0);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899
		= ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x41c);
	vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_BASE_OFFSET_ADDR, 0xBAC);
	vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_AXI_LAYER_BUS_BCRM_BASE_ADDR, 0xc);
}

void consys_debug_deinit_mt6899_debug_gen(void)
{
	if (vir_addr_consys_dbg_gen_srclkenrc_base_mt6899)
		iounmap(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899);

	if (vir_addr_consys_dbg_gen_topckgen_base_mt6899)
		iounmap(vir_addr_consys_dbg_gen_topckgen_base_mt6899);

	if (vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899)
		iounmap(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899);

	if (vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899);
}

void update_debug_read_info_mt6899_debug_gen(
		struct conn_debug_info_mt6899 *info,
		char *tag,
...
void update_debug_write_info_mt6899_debug_gen(
		struct conn_debug_info_mt6899 *info,
		char *tag,
...
void consys_print_power_debug_dbg_level_0_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;

	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt6899));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_srclkenrc_base_mt6899) {
		pr_notice("vir_addr_consys_dbg_gen_srclkenrc_base_mt6899(%x) ioremap fail\n",
				CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_topckgen_base_mt6899) {
		pr_notice("vir_addr_consys_dbg_gen_topckgen_base_mt6899(%x) ioremap fail\n",
	...
	/* A0 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A0", 0x1C001000 + CONSYS_DBG_GEN_SPM_REQ_STA_3_OFFSET_ADDR,
	...
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
	...
	/* A7 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A7", 0x1C00D000 + CONSYS_DBG_GEN_PMRC_DEBUG_LATCH_CMD_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMRC_DEBUG_LATCH_CMD_OFFSET_ADDR));

	/* A8 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A8", 0x1C00D000 + CONSYS_DBG_GEN_PMIF_M_ERR_INFO_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIF_M_ERR_INFO_OFFSET_ADDR));

	/* A9 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A9", 0x1C00D000 + CONSYS_DBG_GEN_PMIF_P_ERR_INFO_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIF_P_ERR_INFO_OFFSET_ADDR));

	/* A10 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A10", 0x1C00D000 + CONSYS_DBG_GEN_PMIF_M_ERR_LASTONE_INFO_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIF_M_ERR_LASTONE_INFO_OFFSET_ADDR));

	/* A11 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A11", 0x1C00D000 + CONSYS_DBG_GEN_PMIF_P_ERR_LASTONE_INFO_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIF_P_ERR_LASTONE_INFO_OFFSET_ADDR));

	/* A12 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A12", 0x1C00D000 + CONSYS_DBG_GEN_SRCLKEN_SW_CONTRAL_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SRCLKEN_SW_CONTRAL_OFFSET_ADDR));

	/* A13 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A13", 0x1C00D000 + CONSYS_DBG_GEN_PMIC_STARTER_OPEN_CNT_ERR_CMD_LATCH_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIC_STARTER_OPEN_CNT_ERR_CMD_LATCH_OFFSET_ADDR));

	/* A14 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A14", 0x1C00D000 + CONSYS_DBG_GEN_PMIC_STARTER_OPEN_CNT_ERR_INFO_LATCH_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIC_STARTER_OPEN_CNT_ERR_INFO_LATCH_OFFSET_ADDR));

	/* A15 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A15", 0x1C00D000 + CONSYS_DBG_GEN_PMIC_STARTER_OFF_CNT_ERR_CMD_LATCH_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIC_STARTER_OFF_CNT_ERR_CMD_LATCH_OFFSET_ADDR));

	/* A16 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A16", 0x1C00D000 + CONSYS_DBG_GEN_PMIC_STARTER_OFF_CNT_ERR_INFO_LATCH_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_PMIC_STARTER_OFF_CNT_ERR_INFO_LATCH_OFFSET_ADDR));

	/* A17 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A17", 0x1C00D000 + CONSYS_DBG_GEN_OPEN_CNT_ERR_SYS_TIMER_LATCH_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_OPEN_CNT_ERR_SYS_TIMER_LATCH_LSB_OFFSET_ADDR));

	/* A18 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A18", 0x1C00D000 + CONSYS_DBG_GEN_OPEN_CNT_ERR_SYS_TIMER_LATCH_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_OPEN_CNT_ERR_SYS_TIMER_LATCH_MSB_OFFSET_ADDR));

	/* A19 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A19", 0x1C00D000 + CONSYS_DBG_GEN_OFF_CNT_ERR_SYS_TIMER_LATCH_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_OFF_CNT_ERR_SYS_TIMER_LATCH_LSB_OFFSET_ADDR));

	/* A20 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A20", 0x1C00D000 + CONSYS_DBG_GEN_OFF_CNT_ERR_SYS_TIMER_LATCH_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
	...
	/* A22 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A22", 0x1C00D000 + CONSYS_DBG_GEN_SPMI_P_STA_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SPMI_P_STA_0_OFFSET_ADDR));

	/* A23 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A23", 0x1C001000 + CONSYS_DBG_GEN_CONN_PWR_CON_OFFSET_ADDR,
		CONSYS_REG_READ(SPM_REG_BASE +
			CONSYS_DBG_GEN_CONN_PWR_CON_OFFSET_ADDR));

	/* A24 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A24", 0x10000000 + CONSYS_DBG_GEN_CLK_CFG_14_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_topckgen_base_mt6899 +
			CONSYS_DBG_GEN_CLK_CFG_14_OFFSET_ADDR));

	/* A25 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A25", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_0_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_0_0_OFFSET_ADDR));

	/* A26 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A26", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_0_1_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_0_1_OFFSET_ADDR));

	/* A27 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A27", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_0_2_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_0_2_OFFSET_ADDR));

	/* A28 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A28", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_0_3_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_0_3_OFFSET_ADDR));

	/* A29 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A29", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_1_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_1_0_OFFSET_ADDR));

	/* A30 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A30", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_1_1_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_1_1_OFFSET_ADDR));

	/* A31 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A31", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_1_2_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_1_2_OFFSET_ADDR));

	/* A32 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A32", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_1_3_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_1_3_OFFSET_ADDR));

	/* A33 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A33", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_2_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_2_0_OFFSET_ADDR));

	/* A34 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A34", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_2_1_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_2_1_OFFSET_ADDR));

	/* A35 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A35", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_2_2_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_2_2_OFFSET_ADDR));

	/* A36 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A36", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_2_3_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_2_3_OFFSET_ADDR));

	/* A37 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A37", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_3_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_3_0_OFFSET_ADDR));

	/* A38 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A38", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_3_1_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_3_1_OFFSET_ADDR));

	/* A39 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A39", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_3_2_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_3_2_OFFSET_ADDR));

	/* A40 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A40", 0x1C00D000 + CONSYS_DBG_GEN_DEBUG_TRACE_3_3_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_DEBUG_TRACE_3_3_OFFSET_ADDR));

	/* A41 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A41", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_0_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_0_LSB_OFFSET_ADDR));

	/* A42 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A42", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_0_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_0_MSB_OFFSET_ADDR));

	/* A43 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A43", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_1_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_1_LSB_OFFSET_ADDR));

	/* A44 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A44", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_1_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_1_MSB_OFFSET_ADDR));

	/* A45 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A45", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_2_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_2_LSB_OFFSET_ADDR));

	/* A46 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A46", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_2_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_2_MSB_OFFSET_ADDR));

	/* A47 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A47", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_3_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_3_LSB_OFFSET_ADDR));

	/* A48 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A48", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_3_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_3_MSB_OFFSET_ADDR));

	/* A49 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A49", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_4_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_4_LSB_OFFSET_ADDR));

	/* A50 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A50", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_4_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_4_MSB_OFFSET_ADDR));

	/* A51 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A51", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_5_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_5_LSB_OFFSET_ADDR));

	/* A52 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A52", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_5_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_5_MSB_OFFSET_ADDR));

	/* A53 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A53", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_6_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_6_LSB_OFFSET_ADDR));

	/* A54 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A54", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_6_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_6_MSB_OFFSET_ADDR));

	/* A55 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A55", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_7_LSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_7_LSB_OFFSET_ADDR));

	/* A56 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A56", 0x1C00D000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_7_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_7_MSB_OFFSET_ADDR));

	/* A57 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_0_info,
		"A57", 0x1C00D000 + CONSYS_DBG_GEN_CMD_STA_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6899 +
			CONSYS_DBG_GEN_CMD_STA_0_OFFSET_ADDR));
}

void consys_print_power_debug_dbg_level_1_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;

	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt6899));

	if (level < 1)
		return;

	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899(%x) ioremap fail\n",
	...
	update_debug_write_info_mt6899_debug_gen(pdbg_level_1_info,
		"B0", 0x18060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
		0, 2, 0x0);

	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
	...
	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899 +
...
void consys_print_power_debug_dbg_level_2_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;

	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt6899));

	if (level < 2)
		return;

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899(%x) ioremap fail\n",
	...
	/* C0 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
	...
	update_debug_write_info_mt6899_debug_gen(pdbg_level_2_info,
		NULL, 0x18011000 + CONSYS_DBG_GEN_EMI_CTL_0_OFFSET_ADDR,
		21, 22, 0x0);

	/* C12 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C12", 0x18011000 + CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_BASE +
	...
	/* C13 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C13", 0x18011000 + CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_BASE +
			CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR));
	...
	/* C14 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C14", 0x18011000 + CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_BASE +
			CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR));
	...
	/* C15 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C15", 0x18011000 + CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_BASE +
			CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR));

	/* C16 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C16", 0x18050000 + 0xB94,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xB94));

	/* C17 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C17", 0x18050000 + 0xB98,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xB98));

	/* C18 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C18", 0x18050000 + 0xB9C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xB9C));

	/* C19 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C19", 0x18050000 + 0xBA0,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xBA0));

	/* C20 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C20", 0x18050000 + 0xBA4,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xBA4));

	/* C21 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C21", 0x18050000 + 0xBA8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xBA8));

	/* C22 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		"C22", 0x18050000 + 0xBAC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6899 + 0xBAC));
...
void consys_print_bus_debug_dbg_level_1_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
	...
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6899 +
...
void consys_print_bus_debug_dbg_level_2_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	if (!vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6899_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6899 +
...
void consys_print_bus_slpprot_debug_dbg_level_2_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
...
void consys_print_bus_slpprot_debug_dbg_level_0_mt6899_debug_gen(
		int level,
		struct conn_debug_info_mt6899 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
