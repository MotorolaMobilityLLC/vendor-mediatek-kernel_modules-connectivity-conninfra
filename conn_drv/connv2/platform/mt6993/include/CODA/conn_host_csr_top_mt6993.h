...
//[Revision time]   : Wed Oct 30 15:12:45 2024
...
#define CONN_HOST_CSR_TOP_BASE                                 (CONN_HOST_CSR_TOP_BASE_ADDR_MT6993) // 0x40060000
...
#define CONN_HOST_CSR_TOP_CONN_INFRA_EMI_THROTTLE_CFG_ADDR     (CONN_HOST_CSR_TOP_BASE + 0x128) // 0128
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR        (CONN_HOST_CSR_TOP_BASE + 0x12C) // 012C
...
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_0_ADDR        (CONN_HOST_CSR_TOP_BASE + 0x1B4) // 01B4
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_1_ADDR        (CONN_HOST_CSR_TOP_BASE + 0x1B8) // 01B8
...
#define CONN_HOST_CSR_TOP_CONN_INFRA_ON_MONFLAG_ADDR           (CONN_HOST_CSR_TOP_BASE + 0xA14) // 0A14
...
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_MCU_EMI_BASE_ADDR_ADDR (CONN_HOST_CSR_TOP_BASE + 0x8354) // 8354
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_MD_SHARE_EMI_BASE_ADDR_ADDR (CONN_HOST_CSR_TOP_BASE + 0x835C) // 835C
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_GPS_EMI_BASE_ADDR_ADDR (CONN_HOST_CSR_TOP_BASE + 0x8360) // 8360
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_EMI_LOCK_ADDR          (CONN_HOST_CSR_TOP_BASE + 0x8364) // 8364
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_MODE_SWITCH_ADDR       (CONN_HOST_CSR_TOP_BASE + 0x8368) // 8368
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_ADDR    (CONN_HOST_CSR_TOP_BASE + 0x83C0) // 83C0
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_EN_ADDR (CONN_HOST_CSR_TOP_BASE + 0x83C4) // 83C4
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SWITCH_ADDR       (CONN_HOST_CSR_TOP_BASE + 0x83C8) // 83C8
#define CONN_HOST_CSR_TOP_CONN_INFRA_DOMAIN_CHK_LOCK_ADDR      (CONN_HOST_CSR_TOP_BASE + 0x83CC) // 83CC
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_MAWD_SECURITY_EN_ADDR (CONN_HOST_CSR_TOP_BASE + 0x83D0) // 83D0
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_SWITCH_ADDR    (CONN_HOST_CSR_TOP_BASE + 0x83D4) // 83D4
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_LOCK_ADDR      (CONN_HOST_CSR_TOP_BASE + 0x83D8) // 83D8
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_DOMAIN_REPALCE_EN_ADDR (CONN_HOST_CSR_TOP_BASE + 0x83DC) // 83DC
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_SWITCH_ADDR       (CONN_HOST_CSR_TOP_BASE + 0x83E0) // 83E0
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_LOCK_ADDR         (CONN_HOST_CSR_TOP_BASE + 0x83E4) // 83E4
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_ADDR (CONN_HOST_CSR_TOP_BASE + 0x83F0) // 83F0
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_ADDR_SEC_CONFIG_ADDR (CONN_HOST_CSR_TOP_BASE + 0x83F4) // 83F4
...
/* =====================================================================================
  ...
  ---CONN_INFRA_EMI_THROTTLE_CFG (0x18060000 + 0x128)---

    CR_CONN2AP_EMI_THROTTLE_MASK[4..0] - (RW) [0]: mask conn2ap emi path slpprot throttle en
                                     [1]: mask mawd2conn slpprot throttle en
                                     [2]: mask bgsys RV33 path  throttle en
                                     [3]: mask bgsys G_DMA path throttle en
                                     [4]: mask gps2conn slpprpt throttle en
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_EMI_THROTTLE_CFG_CR_CONN2AP_EMI_THROTTLE_MASK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_EMI_THROTTLE_CFG_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_EMI_THROTTLE_CFG_CR_CONN2AP_EMI_THROTTLE_MASK_MASK 0x0000001F                // CR_CONN2AP_EMI_THROTTLE_MASK[4..0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_EMI_THROTTLE_CFG_CR_CONN2AP_EMI_THROTTLE_MASK_SHFT 0

/* =====================================================================================

  ---BG_AHB_THROTTLE_REMAP_EN (0x18060000 + 0x12C)---

    REMAP_EN[0]                  - (RW) if have conn2ap remapping window used , this bit need write 1
    EMI_MCU_REMAP_EN[1]          - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    EMI_MD_SHARE_REMAP_EN[2]     - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    EMI_GPS_REMAP_EN[3]          - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    SCPSYS_SRAM_EN[4]            - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    PERI_WF_REMAP_EN[5]          - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    PERI_BT_REMAP_EN[6]          - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    PERI_GPS_REMAP_EN[7]         - (RW) if this conn2ap remapping window used to access EMI, this bit need write 1
    RESERVED8[31..8]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_GPS_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_GPS_REMAP_EN_MASK 0x00000080                // PERI_GPS_REMAP_EN[7]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_GPS_REMAP_EN_SHFT 7
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_BT_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_BT_REMAP_EN_MASK 0x00000040                // PERI_BT_REMAP_EN[6]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_BT_REMAP_EN_SHFT 6
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_WF_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_WF_REMAP_EN_MASK 0x00000020                // PERI_WF_REMAP_EN[5]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_PERI_WF_REMAP_EN_SHFT 5
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_SCPSYS_SRAM_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_SCPSYS_SRAM_EN_MASK 0x00000010                // SCPSYS_SRAM_EN[4]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_SCPSYS_SRAM_EN_SHFT 4
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_GPS_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_GPS_REMAP_EN_MASK 0x00000008                // EMI_GPS_REMAP_EN[3]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_GPS_REMAP_EN_SHFT 3
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_MD_SHARE_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_MD_SHARE_REMAP_EN_MASK 0x00000004                // EMI_MD_SHARE_REMAP_EN[2]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_MD_SHARE_REMAP_EN_SHFT 2
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_MCU_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_MCU_REMAP_EN_MASK 0x00000002                // EMI_MCU_REMAP_EN[1]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_EMI_MCU_REMAP_EN_SHFT 1
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_REMAP_EN_ADDR CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_ADDR
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_REMAP_EN_MASK 0x00000001                // REMAP_EN[0]
#define CONN_HOST_CSR_TOP_BG_AHB_THROTTLE_REMAP_EN_REMAP_EN_SHFT 0
...
/* =====================================================================================
  ...
  ---CONN_INFRA_WAKEPU_MAWD_0 (0x18060000 + 0x1B4)---

    CONN_INFRA_WAKEPU_MAWD_0[0]  - (RW)  xxx 
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_0_CONN_INFRA_WAKEPU_MAWD_0_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_0_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_0_CONN_INFRA_WAKEPU_MAWD_0_MASK 0x00000001                // CONN_INFRA_WAKEPU_MAWD_0[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_0_CONN_INFRA_WAKEPU_MAWD_0_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_WAKEPU_MAWD_1 (0x18060000 + 0x1B8)---

    CONN_INFRA_WAKEPU_MAWD_1[0]  - (RW)  xxx 
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_1_CONN_INFRA_WAKEPU_MAWD_1_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_1_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_1_CONN_INFRA_WAKEPU_MAWD_1_MASK 0x00000001                // CONN_INFRA_WAKEPU_MAWD_1[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_WAKEPU_MAWD_1_CONN_INFRA_WAKEPU_MAWD_1_SHFT 0
...
/* =====================================================================================
  ...
  ---CONN_INFRA_ON_MONFLAG (0x18060000 + 0xA14)---

    CONN_INFRA_ON_MONFLAG_OUT[31..0] - (RO)  xxx 

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_ON_MONFLAG_CONN_INFRA_ON_MONFLAG_OUT_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_ON_MONFLAG_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_ON_MONFLAG_CONN_INFRA_ON_MONFLAG_OUT_MASK 0xFFFFFFFF                // CONN_INFRA_ON_MONFLAG_OUT[31..0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_ON_MONFLAG_CONN_INFRA_ON_MONFLAG_OUT_SHFT 0
...
/* =====================================================================================
  ...
  ---CONN2AP_REMAP_MCU_EMI_BASE_ADDR (0x18060000 + 0x8354)---

    CONN2AP_REMAP_MCU_EMI_BASE_ADDR[19..0] - (RW)  xxx 
...
/* =====================================================================================
  ...
  ---CONN2AP_REMAP_MD_SHARE_EMI_BASE_ADDR (0x18060000 + 0x835C)---

    CONN2AP_REMAP_MD_SHARE_EMI_BASE_ADDR[19..0] - (RW)  xxx 
    RESERVED20[31..20]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---CONN2AP_REMAP_GPS_EMI_BASE_ADDR (0x18060000 + 0x8360)---

    CONN2AP_REMAP_GPS_EMI_BASE_ADDR[19..0] - (RW)  xxx 
    RESERVED20[31..20]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---CONN2AP_REMAP_EMI_LOCK (0x18060000 + 0x8364)---

    CONN2AP_REMAP_EMI_LOCK[0]    - (RW)  xxx 
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_EMI_LOCK_CONN2AP_REMAP_EMI_LOCK_ADDR CONN_HOST_CSR_TOP_CONN2AP_REMAP_EMI_LOCK_ADDR
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_EMI_LOCK_CONN2AP_REMAP_EMI_LOCK_MASK 0x00000001                // CONN2AP_REMAP_EMI_LOCK[0]
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_EMI_LOCK_CONN2AP_REMAP_EMI_LOCK_SHFT 0

/* =====================================================================================

  ---CONN2AP_REMAP_MODE_SWITCH (0x18060000 + 0x8368)---

    CONN2AP_REMAP_MODE_SWITCH[0] - (RW)  xxx 
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_MODE_SWITCH_CONN2AP_REMAP_MODE_SWITCH_ADDR CONN_HOST_CSR_TOP_CONN2AP_REMAP_MODE_SWITCH_ADDR
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_MODE_SWITCH_CONN2AP_REMAP_MODE_SWITCH_MASK 0x00000001                // CONN2AP_REMAP_MODE_SWITCH[0]
#define CONN_HOST_CSR_TOP_CONN2AP_REMAP_MODE_SWITCH_CONN2AP_REMAP_MODE_SWITCH_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_AP2CONN_DOMAIN_ID (0x18060000 + 0x83C0)---

    CR_AP2CONN_DOMAIN_ID[7..0]   - (RW) [3:0] md2conn domain id 
                                     [7:4] ap2conn domain id
    RESERVED8[31..8]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_CR_AP2CONN_DOMAIN_ID_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_CR_AP2CONN_DOMAIN_ID_MASK 0x000000FF                // CR_AP2CONN_DOMAIN_ID[7..0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_CR_AP2CONN_DOMAIN_ID_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_AP2CONN_DOMAIN_ID_EN (0x18060000 + 0x83C4)---

    CR_AP2CONN_DOMAIN_ID_EN[1..0] - (RW) [0]: enable  md2conn domain id check
                                     [1]: enable ap2conn domain id check
    RESERVED2[31..2]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_EN_CR_AP2CONN_DOMAIN_ID_EN_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_EN_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_EN_CR_AP2CONN_DOMAIN_ID_EN_MASK 0x00000003                // CR_AP2CONN_DOMAIN_ID_EN[1..0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_DOMAIN_ID_EN_CR_AP2CONN_DOMAIN_ID_EN_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_AP2CONN_SWITCH (0x18060000 + 0x83C8)---

    CR_REMAP_MODE_SWITCH_AP2CONN_DOMAIN_CHK[0] - (RW) security write switch,after wirte done, need set 1'b1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SWITCH_CR_REMAP_MODE_SWITCH_AP2CONN_DOMAIN_CHK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SWITCH_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SWITCH_CR_REMAP_MODE_SWITCH_AP2CONN_DOMAIN_CHK_MASK 0x00000001                // CR_REMAP_MODE_SWITCH_AP2CONN_DOMAIN_CHK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SWITCH_CR_REMAP_MODE_SWITCH_AP2CONN_DOMAIN_CHK_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_DOMAIN_CHK_LOCK (0x18060000 + 0x83CC)---

    AP2CONN_DOMAIN_CHK_LOCK[0]   - (RW) security write switch,after wirte done, switch 1'b1, then need set lock 1'b1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_DOMAIN_CHK_LOCK_AP2CONN_DOMAIN_CHK_LOCK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_DOMAIN_CHK_LOCK_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_DOMAIN_CHK_LOCK_AP2CONN_DOMAIN_CHK_LOCK_MASK 0x00000001                // AP2CONN_DOMAIN_CHK_LOCK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_DOMAIN_CHK_LOCK_AP2CONN_DOMAIN_CHK_LOCK_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CMDBT2CONN_MAWD_SECURITY_EN (0x18060000 + 0x83D0)---

    CR_DOMAIN_ID_CHK_EN[0]       - (RW) enable CMDBT mawd security addr protector
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_MAWD_SECURITY_EN_CR_DOMAIN_ID_CHK_EN_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_MAWD_SECURITY_EN_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_MAWD_SECURITY_EN_CR_DOMAIN_ID_CHK_EN_MASK 0x00000001                // CR_DOMAIN_ID_CHK_EN[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_MAWD_SECURITY_EN_CR_DOMAIN_ID_CHK_EN_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CMDBT2CONN_SWITCH (0x18060000 + 0x83D4)---

    CR_REMAP_MODE_SWITCH_CMDBT2CONN_DOMAIN_CHK[0] - (RW) security write switch,after wirte done, need set 1'b1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_SWITCH_CR_REMAP_MODE_SWITCH_CMDBT2CONN_DOMAIN_CHK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_SWITCH_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_SWITCH_CR_REMAP_MODE_SWITCH_CMDBT2CONN_DOMAIN_CHK_MASK 0x00000001                // CR_REMAP_MODE_SWITCH_CMDBT2CONN_DOMAIN_CHK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_SWITCH_CR_REMAP_MODE_SWITCH_CMDBT2CONN_DOMAIN_CHK_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CMDBT2CONN_LOCK (0x18060000 + 0x83D8)---

    CMDBT2CONN_DOMAIN_CHK_LOCK[0] - (RW) security write switch,after wirte done, switch 1'b1, then need set lock 1'b1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_LOCK_CMDBT2CONN_DOMAIN_CHK_LOCK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_LOCK_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_LOCK_CMDBT2CONN_DOMAIN_CHK_LOCK_MASK 0x00000001                // CMDBT2CONN_DOMAIN_CHK_LOCK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_CMDBT2CONN_LOCK_CMDBT2CONN_DOMAIN_CHK_LOCK_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CONN2AP_DOMAIN_REPALCE_EN (0x18060000 + 0x83DC)---

    CR_CONN2AP_DOMAIN_ID_REPLACE[0] - (RW) enable conn2ap domain repalce
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_DOMAIN_REPALCE_EN_CR_CONN2AP_DOMAIN_ID_REPLACE_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_DOMAIN_REPALCE_EN_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_DOMAIN_REPALCE_EN_CR_CONN2AP_DOMAIN_ID_REPLACE_MASK 0x00000001                // CR_CONN2AP_DOMAIN_ID_REPLACE[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_DOMAIN_REPALCE_EN_CR_CONN2AP_DOMAIN_ID_REPLACE_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CONN2AP_SWITCH (0x18060000 + 0x83E0)---

    CR_REMAP_MODE_SWITCH_CONN2AP_DOMAIN_CHK[0] - (RW) security write switch,after wirte done, need set 1'b1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_SWITCH_CR_REMAP_MODE_SWITCH_CONN2AP_DOMAIN_CHK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_SWITCH_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_SWITCH_CR_REMAP_MODE_SWITCH_CONN2AP_DOMAIN_CHK_MASK 0x00000001                // CR_REMAP_MODE_SWITCH_CONN2AP_DOMAIN_CHK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_SWITCH_CR_REMAP_MODE_SWITCH_CONN2AP_DOMAIN_CHK_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CONN2AP_LOCK (0x18060000 + 0x83E4)---

    CONN2AP_DOMAIN_CHK_LOCK[0]   - (RW) security write switch,after wirte done, switch 1'b1, then need set lock 1'b1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_LOCK_CONN2AP_DOMAIN_CHK_LOCK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_LOCK_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_LOCK_CONN2AP_DOMAIN_CHK_LOCK_MASK 0x00000001                // CONN2AP_DOMAIN_CHK_LOCK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_CONN2AP_LOCK_CONN2AP_DOMAIN_CHK_LOCK_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG (0x18060000 + 0x83F0)---

    CR_SUBSYS2_END[15..0]        - (RW) secuirty write, and un lock
    CR_SUBSYS2_BEGIN[31..16]     - (RW) secuirty write, and un lock

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_CR_SUBSYS2_BEGIN_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_CR_SUBSYS2_BEGIN_MASK 0xFFFF0000                // CR_SUBSYS2_BEGIN[31..16]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_CR_SUBSYS2_BEGIN_SHFT 16
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_CR_SUBSYS2_END_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_CR_SUBSYS2_END_MASK 0x0000FFFF                // CR_SUBSYS2_END[15..0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_SUBSYS2_ADDR_CONFIG_CR_SUBSYS2_END_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_AP2CONN_ADDR_SEC_CONFIG (0x18060000 + 0x83F4)---

    AP2CONN_ADDR_CHK_LOCK[0]     - (RW) secuirty write, 
                                     1: lock
                                     0:un lock
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_ADDR_SEC_CONFIG_AP2CONN_ADDR_CHK_LOCK_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_ADDR_SEC_CONFIG_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_ADDR_SEC_CONFIG_AP2CONN_ADDR_CHK_LOCK_MASK 0x00000001                // AP2CONN_ADDR_CHK_LOCK[0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AP2CONN_ADDR_SEC_CONFIG_AP2CONN_ADDR_CHK_LOCK_SHFT 0
