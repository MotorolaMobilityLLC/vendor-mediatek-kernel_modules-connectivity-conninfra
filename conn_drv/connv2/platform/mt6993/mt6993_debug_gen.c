 ...
 *
 * This file, mt6993_debug_gen.c was automatically generated
 * by the tool from the DEBUG data DE provided.
 * It should not be modified by hand.
 *
 * Reference debug file,
 * - [Jxxxr]connsys_power_debug.xlsx (Modified date: 2024-12-09)
 * - (Jxxxr) conn_infra_bus_debug_ctrl_241114.xlsx (Modified date: 2024-12-09)
 * - [Jxxxr]conn_infra_top_debug_related_cr.xlsx (Modified date: 2024-11-27)
 */
...
#include "mt6993_debug_gen.h"
#include "conninfra.h"


mapped_addr vir_addr_consys_dbg_gen_conn_gpio_base_mt6993;
mapped_addr vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993;
mapped_addr vir_addr_consys_dbg_gen_vlpcfg_base_mt6993;
mapped_addr vir_addr_0x1c00d000_mt6993;
mapped_addr vir_addr_0x10000000_mt6993;
mapped_addr vir_addr_consys_dbg_gen_srclkenrc_base_mt6993;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993;
mapped_addr vir_addr_0x4004c000_mt6993;
mapped_addr vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993;
mapped_addr vir_addr_0x40049100_mt6993;
mapped_addr vir_addr_0x40049900_mt6993;

void consys_debug_init_mt6993_debug_gen(void)
{
	vir_addr_consys_dbg_gen_conn_gpio_base_mt6993
		= ioremap(CONSYS_DBG_GEN_CONN_GPIO_BASE_ADDR, 0x58);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993
		= ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x41c);
	vir_addr_consys_dbg_gen_vlpcfg_base_mt6993
		= ioremap(CONSYS_DBG_GEN_VLPCFG_BASE_ADDR, 0xE04);
	vir_addr_0x1c00d000_mt6993
		= ioremap(0x1C00D000, 0x77C);
	vir_addr_0x10000000_mt6993
		= ioremap(0x10000000, 0x40);
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6993
		= ioremap(CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR, 0x72C);
	vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_OFFSET_ADDR, 0xACC);
	vir_addr_0x4004c000_mt6993
		= ioremap(0x4004c000, 0x10);
	vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993
		= ioremap(CONSYS_DBG_GEN_APIFRBUS_AO_IO_REG_BASE_ADDR, 0xC);
	vir_addr_0x40049100_mt6993
		= ioremap(0x40049100, 0x10);
	vir_addr_0x40049900_mt6993
		= ioremap(0x40049900, 0x10);
}

void consys_debug_deinit_mt6993_debug_gen(void)
{
	if (vir_addr_consys_dbg_gen_conn_gpio_base_mt6993)
		iounmap(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993);

	if (vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993)
		iounmap(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993);

	if (vir_addr_consys_dbg_gen_vlpcfg_base_mt6993)
		iounmap(vir_addr_consys_dbg_gen_vlpcfg_base_mt6993);

	if (vir_addr_0x1c00d000_mt6993)
		iounmap(vir_addr_0x1c00d000_mt6993);

	if (vir_addr_0x10000000_mt6993)
		iounmap(vir_addr_0x10000000_mt6993);

	if (vir_addr_consys_dbg_gen_srclkenrc_base_mt6993)
		iounmap(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993);

	if (vir_addr_0x4004c000_mt6993)
		iounmap(vir_addr_0x4004c000_mt6993);

	if (vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993)
		iounmap(vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993);

	if (vir_addr_0x40049100_mt6993)
		iounmap(vir_addr_0x40049100_mt6993);

	if (vir_addr_0x40049900_mt6993)
		iounmap(vir_addr_0x40049900_mt6993);
}

void update_debug_read_info_mt6993_debug_gen(
		struct conn_debug_info_mt6993 *info,
		char *tag,
...
void update_debug_write_info_mt6993_debug_gen(
		struct conn_debug_info_mt6993 *info,
		char *tag,
...
void consys_print_power_debug_dbg_level_0_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;

	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt6993));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_vlpcfg_base_mt6993) {
		pr_notice("vir_addr_consys_dbg_gen_vlpcfg_base_mt6993(%x) ioremap fail\n",
				CONSYS_DBG_GEN_VLPCFG_BASE_ADDR);
		return;
	}

	if (!vir_addr_0x1c00d000_mt6993) {
		pr_notice("vir_addr_0x1c00d000_mt6993(%x) ioremap fail\n",
				0x1C00D000);
		return;
	}

	if (!vir_addr_0x10000000_mt6993) {
		pr_notice("vir_addr_0x10000000_mt6993(%x) ioremap fail\n",
				0x10000000);
		return;
	}

	if (!vir_addr_consys_dbg_gen_srclkenrc_base_mt6993) {
		pr_notice("vir_addr_consys_dbg_gen_srclkenrc_base_mt6993(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A0", 0x1C001000 + 0x85C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_vlpcfg_base_mt6993 + 0x85C));

	/* A1 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A1", 0x1C00D000 + 0x100,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x100));

	/* A2 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A2", 0x1C00D000 + 0x104,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x104));

	/* A3 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A3", 0x1C00D000 + 0x108,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x108));

	/* A4 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A4", 0x1C00D000 + 0x10C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x10C));

	/* A5 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A5", 0x1C00D000 + 0x110,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x110));

	/* A6 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A6", 0x1C00D000 + 0x114,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x114));

	/* A7 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A7", 0x1C00D000 + 0x118,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x118));

	/* A8 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A8", 0x1C00D000 + 0x11C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x11C));

	/* A9 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A9", 0x1C00D000 + 0x120,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x120));

	/* A10 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A10", 0x1C00D000 + 0x124,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x124));

	/* A11 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A11", 0x1C00D000 + 0x128,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x128));

	/* A12 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A12", 0x1C00D000 + 0x12C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x12C));

	/* A13 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A13", 0x1C00D000 + 0x130,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x130));

	/* A14 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A14", 0x1C00D000 + 0x134,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x134));

	/* A15 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A15", 0x1C00D000 + 0x138,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x138));

	/* A16 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A16", 0x1C00D000 + 0x13C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x13C));

	/* A17 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A17", 0x1C00D000 + 0x140,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x140));

	/* A18 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A18", 0x1C00D000 + 0x144,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x144));

	/* A19 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A19", 0x1C00D000 + 0x148,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x148));

	/* A20 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A20", 0x1C00D000 + 0x14C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x14C));

	/* A21 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A21", 0x1C00D000 + 0x150,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x150));

	/* A22 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A22", 0x1C001000 + 0xE04,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_vlpcfg_base_mt6993 + 0xE04));

	/* A23 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A23", 0x10000000 + 0x40,
		CONSYS_REG_READ(vir_addr_0x10000000_mt6993 + 0x40));

	/* A24 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A24", 0x1C00D000 + 0x700,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x700));

	/* A25 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A25", 0x1C00D000 + 0x704,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x704));

	/* A26 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A26", 0x1C00D000 + 0x708,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x708));

	/* A27 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A27", 0x1C00D000 + 0x70C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x70C));

	/* A28 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A28", 0x1C00D000 + 0x710,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x710));

	/* A29 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A29", 0x1C00D000 + 0x714,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x714));

	/* A30 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A30", 0x1C00D000 + 0x718,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x718));

	/* A31 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A31", 0x1C00D000 + 0x71C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x71C));

	/* A32 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A32", 0x1C00D000 + 0x720,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x720));

	/* A33 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A33", 0x1C00D000 + 0x724,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x724));

	/* A34 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A34", 0x1C00D000 + 0x728,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x728));

	/* A35 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A35", 0x1C00D000 + 0x72C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x72C));

	/* A36 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A36", 0x1C00D000 + 0x730,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x730));

	/* A37 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A37", 0x1C00D000 + 0x734,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x734));

	/* A38 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A38", 0x1C00D000 + 0x738,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x738));

	/* A39 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A39", 0x1C00D000 + 0x73C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x73C));

	/* A40 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A40", 0x1C00D000 + 0x740,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x740));

	/* A41 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A41", 0x1C00D000 + 0x744,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x744));

	/* A42 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A42", 0x1C00D000 + 0x748,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x748));

	/* A43 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A43", 0x1C00D000 + 0x74C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x74C));

	/* A44 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A44", 0x1C00D000 + 0x750,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x750));

	/* A45 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A45", 0x1C00D000 + 0x754,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x754));

	/* A46 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A46", 0x1C00D000 + 0x758,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x758));

	/* A47 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A47", 0x1C00D000 + 0x75C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x75C));

	/* A48 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A48", 0x1C00D000 + 0x760,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x760));

	/* A49 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A49", 0x1C00D000 + 0x764,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x764));

	/* A50 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A50", 0x1C00D000 + 0x768,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x768));

	/* A51 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A51", 0x1C00D000 + 0x76C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x76C));

	/* A52 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A52", 0x1C00D000 + 0x770,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x770));

	/* A53 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A53", 0x1C00D000 + 0x774,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x774));

	/* A54 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A54", 0x1C00D000 + 0x778,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x778));

	/* A55 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A55", 0x1C00D000 + 0x77C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt6993 + 0x77C));

	/* A56 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A56", 0x1C011000 + CONSYS_DBG_GEN_M06_SRCLKEN_CFG_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
			CONSYS_DBG_GEN_M06_SRCLKEN_CFG_OFFSET_ADDR));

	/* A57 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A57", 0x1C011000 + CONSYS_DBG_GEN_M09_SRCLKEN_CFG_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
			CONSYS_DBG_GEN_M09_SRCLKEN_CFG_OFFSET_ADDR));

	/* A58 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A58", 0x1C011000 + CONSYS_DBG_GEN_M06_REQ_STA_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
			CONSYS_DBG_GEN_M06_REQ_STA_0_OFFSET_ADDR));

	/* A59 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A59", 0x1C011000 + CONSYS_DBG_GEN_M09_REQ_STA_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
			CONSYS_DBG_GEN_M09_REQ_STA_0_OFFSET_ADDR));

	/* A60 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A60", 0x1C011000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_1_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_1_MSB_OFFSET_ADDR));

	/* A61 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A61", 0x1C011000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_3_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
			CONSYS_DBG_GEN_SYS_TIMER_LATCH_3_MSB_OFFSET_ADDR));

	/* A62 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		"A62", 0x1C011000 + CONSYS_DBG_GEN_SYS_TIMER_LATCH_5_MSB_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6993 +
...
void consys_print_power_debug_dbg_level_1_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;

	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt6993));

	if (level < 1)
		return;

	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993(%x) ioremap fail\n",
	...
	update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
		"B0", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
		0, 2, 0x0);

	update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
	...
	update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993 +
...
void consys_print_power_debug_dbg_level_2_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;

	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt6993));

	if (level < 2)
		return;

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993(%x) ioremap fail\n",
	...
	/* C4 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C4", 0x40003000 + CONSYS_DBG_GEN_WB_CK_STA_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
			CONSYS_DBG_GEN_WB_CK_STA_OFFSET_ADDR));

	/* C5 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C5", 0x40003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_0_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
			CONSYS_DBG_GEN_WB_SLP_TOP_CK_0_OFFSET_ADDR));

	/* C6 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C6", 0x40003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
			CONSYS_DBG_GEN_WB_SLP_TOP_CK_1_OFFSET_ADDR));

	/* C7 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C7", 0x40003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_2_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
			CONSYS_DBG_GEN_WB_SLP_TOP_CK_2_OFFSET_ADDR));

	/* C8 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C8", 0x40003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_3_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
			CONSYS_DBG_GEN_WB_SLP_TOP_CK_3_OFFSET_ADDR));

	/* C9 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C9", 0x40003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_4_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
			CONSYS_DBG_GEN_WB_SLP_TOP_CK_4_OFFSET_ADDR));

	/* C10 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C10", 0x40003000 + CONSYS_DBG_GEN_WB_SLP_TOP_CK_5_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_WT_SLP_CTL_REG_BASE +
	...
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993 + 0xAC4));

	/* C16 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C16", 0x40050000 + 0xAC8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993 + 0xAC8));

	/* C17 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"C17", 0x40050000 + 0xACC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6993 + 0xACC));
		...
		struct conn_debug_info_mt6993 *pdbg_level_1_info)
{
	...
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993 +
...
void consys_print_bus_debug_dbg_level_2_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	if (!vir_addr_0x4004c000_mt6993) {
		pr_notice("vir_addr_0x4004c000_mt6993(%x) ioremap fail\n",
				0x4004c000);
		return;
	}
	...
	/* 33 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"33", 0x4000e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_0_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_0_OFFSET_ADDR));

	/* 34 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"34", 0x4000e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_1_OFFSET_ADDR));

	/* 35 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"35", 0x4000e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_2_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
	...
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"36", 0x4004c000 + 0x4,
		CONSYS_REG_READ(vir_addr_0x4004c000_mt6993 + 0x4));

	/* 37 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"37", 0x4004c000 + 0xc,
		CONSYS_REG_READ(vir_addr_0x4004c000_mt6993 + 0xc));
	...
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"48", 0x4004c000 + 0x10,
		CONSYS_REG_READ(vir_addr_0x4004c000_mt6993 + 0x10));
	...
	/* 50 */
	update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
		"50", 0x4000e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_TIMEOUT_APB_ID_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_TIMEOUT_APB_ID_OFFSET_ADDR));

	/* 50 */
	CONSYS_SET_BIT(vir_addr_0x40049100_mt6993, 1);
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993 +
		CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR, 0x1D);
	update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
		"50", 0x40023000 + CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR,
	...
	/* 51 */
	CONSYS_SET_BIT(vir_addr_0x40049900_mt6993, 1);
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993 +
		CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR, 0x1E);
	update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
		"51", 0x40023000 + CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR,
...
void consys_print_bus_slpprot_debug_dbg_level_2_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
...
void consys_print_bus_slpprot_debug_dbg_level_0_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
	...
	if (!vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993) {
		pr_notice("vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6993_debug_gen(pdbg_level_0_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt6993 +
...
void consys_print_top_power_debug_dbg_level_0_mt6993_debug_gen(
		struct conn_debug_info_mt6993 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;
	...
	update_debug_write_info_mt6993_debug_gen(pdbg_level_0_info,
...
void consys_print_infra_top_cr_debug_dbg_level_1_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
	...
	/* A01 */
		...
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A01", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_SYSSTRAP_OUT_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_SYSSTRAP_OUT_OFFSET_ADDR));
	#endif

	/* A02 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A02", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CLKGEN_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CLKGEN_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A03 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x0, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A03", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x0);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A03", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A04 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x1, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A04", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x1);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A04", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A05 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x2, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A05", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x2);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A05", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A06 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x3, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A06", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x3);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A06", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A07 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x4, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A07", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x4);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A07", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A08 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x5, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A08", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x5);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A08", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A09 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x6, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A09", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x6);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A09", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A10 */
		...
		CONSYS_REG_WRITE_MASK(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR, 0x7, 0x7);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A10", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 2, 0x7);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A10", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A11 */
		...
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A11", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_RGU_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 3, 0x0);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A11", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A12 */
		...
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A12", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_RGU_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 3, 0x1);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A12", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A13 */
		...
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A13", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_RGU_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 3, 0x2);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A13", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A14 */
		...
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A14", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_RGU_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 3, 0x3);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A14", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A15 */
		...
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A15", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_RGU_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 3, 0x4);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A15", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR));
	#endif
	...
	/* A16 */
		...
		update_debug_write_info_mt6993_debug_gen(pdbg_level_1_info,
			"A16", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_RGU_ON_DBG_MUX_SEL_OFFSET_ADDR,
			0, 3, 0x5);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_1_info,
			"A16", 0x40060000 + CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_RGU_ON_DBG_OFFSET_ADDR));
	#endif
}

void consys_print_infra_top_cr_debug_dbg_level_2_mt6993_debug_gen(
		int level,
		struct conn_debug_info_mt6993 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	if (!vir_addr_consys_dbg_gen_conn_gpio_base_mt6993) {
		pr_notice("vir_addr_consys_dbg_gen_conn_gpio_base_mt6993(%x) ioremap fail\n",
				CONSYS_DBG_GEN_CONN_GPIO_BASE_ADDR);
		return;
	}
	...
	/* B07 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE_MASK(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL9_OFFSET_ADDR, 0x14, 0x3F);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL9_OFFSET_ADDR,
			0, 5, 0x14);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE_MASK(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL9_OFFSET_ADDR, 0x5C0, 0xFC0);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL9_OFFSET_ADDR,
			6, 11, 0x17);
	#endif
	...
	/* B07 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL1_OFFSET_ADDR, 0x3020100);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL1_OFFSET_ADDR,
			0, 31, 0x3020100);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL2_OFFSET_ADDR, 0x7060504);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL2_OFFSET_ADDR,
			0, 31, 0x7060504);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL3_OFFSET_ADDR, 0xB0A0908);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL3_OFFSET_ADDR,
			0, 31, 0xB0A0908);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL4_OFFSET_ADDR, 0xF0E0D0C);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL4_OFFSET_ADDR,
			0, 31, 0xF0E0D0C);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL5_OFFSET_ADDR, 0x13121110);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL5_OFFSET_ADDR,
			0, 31, 0x13121110);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL6_OFFSET_ADDR, 0x17161514);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL6_OFFSET_ADDR,
			0, 31, 0x17161514);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL7_OFFSET_ADDR, 0x1B1A1918);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL7_OFFSET_ADDR,
			0, 31, 0x1B1A1918);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL8_OFFSET_ADDR, 0x1F1E1D1C);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_MON_SEL8_OFFSET_ADDR,
			0, 31, 0x1F1E1D1C);
	#endif

	/* B07 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_SET_BIT(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_GPIO_MISC_CTRL_OFFSET_ADDR, (0x1U << 1));
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40016000 + CONSYS_DBG_GEN_GPIO_MISC_CTRL_OFFSET_ADDR,
			1, 1, 0x1);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B07", 0x40023000 + CONSYS_DBG_GEN_CONN_INFRA_MONFLAG_OUT_OFFSET_ADDR,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993 +
				CONSYS_DBG_GEN_CONN_INFRA_MONFLAG_OUT_OFFSET_ADDR));
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE_MASK(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL9_OFFSET_ADDR, 0x24, 0x3F);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL9_OFFSET_ADDR,
			0, 5, 0x24);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL1_OFFSET_ADDR, 0x3020100);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL1_OFFSET_ADDR,
			0, 31, 0x3020100);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL2_OFFSET_ADDR, 0x7060504);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL2_OFFSET_ADDR,
			0, 31, 0x7060504);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL3_OFFSET_ADDR, 0xB0A0908);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL3_OFFSET_ADDR,
			0, 31, 0xB0A0908);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL4_OFFSET_ADDR, 0xF0E0D0C);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL4_OFFSET_ADDR,
			0, 31, 0xF0E0D0C);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL5_OFFSET_ADDR, 0x13121110);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL5_OFFSET_ADDR,
			0, 31, 0x13121110);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL6_OFFSET_ADDR, 0x17161514);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL6_OFFSET_ADDR,
			0, 31, 0x17161514);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL7_OFFSET_ADDR, 0x1B1A1918);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL7_OFFSET_ADDR,
			0, 31, 0x1B1A1918);
	#endif
	...
	/* B08 */
		...
		CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_MON_SEL8_OFFSET_ADDR, 0x1F1E1D1C);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_MON_SEL8_OFFSET_ADDR,
			0, 31, 0x1F1E1D1C);
	#endif
	...
	/* B08 */
		...
		CONSYS_SET_BIT(vir_addr_consys_dbg_gen_conn_gpio_base_mt6993 +
			CONSYS_DBG_GEN_GPIO_MISC_CTRL_OFFSET_ADDR, (0x1U << 1));
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40016000 + CONSYS_DBG_GEN_GPIO_MISC_CTRL_OFFSET_ADDR,
			1, 1, 0x1);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B08", 0x40023000 + CONSYS_DBG_GEN_CONN_INFRA_MONFLAG_OUT_OFFSET_ADDR,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6993 +
				CONSYS_DBG_GEN_CONN_INFRA_MONFLAG_OUT_OFFSET_ADDR));
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_EMI_PROBE_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_CFG_BASE +
				CONSYS_DBG_GEN_EMI_PROBE_OFFSET_ADDR));
	#endif

	/* B09 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(CONN_CFG_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR, 0x0);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR,
			0, 31, 0x0);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_CFG_BASE +
				CONSYS_DBG_GEN_EMI_PROBE_1_OFFSET_ADDR));
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + 0x138,
			CONSYS_REG_READ(CONN_CFG_BASE + 0x138));
	#endif

	/* B09 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(CONN_CFG_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR, 0x1);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR,
			0, 31, 0x1);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(CONN_CFG_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR, 0x2);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR,
			0, 31, 0x2);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(CONN_CFG_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR, 0x3);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR,
			0, 31, 0x3);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(CONN_CFG_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR, 0x4);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR,
			0, 31, 0x4);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE(CONN_CFG_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR, 0x5);
		update_debug_write_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_DBG_SEL_OFFSET_ADDR,
			0, 31, 0x5);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_WLA_REQ2ACK_TIMEOUT_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_CFG_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_WLA_REQ2ACK_TIMEOUT_OFFSET_ADDR));
	#endif

	/* B09 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_WLA_URG2ACK_TIMEOUT_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_CFG_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_WLA_URG2ACK_TIMEOUT_OFFSET_ADDR));
	#endif

	/* B09 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_WLA_EN2RDY_TIMEOUT_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_CFG_BASE +
				CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_WLA_EN2RDY_TIMEOUT_OFFSET_ADDR));
	#endif

	/* B09 */
	#ifndef CONFIG_FPGA_EARLY_PORTING
		update_debug_read_info_mt6993_debug_gen(pdbg_level_2_info,
			"B09", 0x40011000 + CONSYS_DBG_GEN_CONN_INFRA_CFG_EMI_CTL_HRT_TIMEOUT_OFFSET_ADDR,
			CONSYS_REG_READ(CONN_CFG_BASE +
